...
public class FunctionLibrary {
	...
	//method for to click buttons,links,checkboxes ,radiobutton and images
	...
	public static void stockTable()throws Throwable
	{
		...
		FileReader fi = new FileReader("./CaptureData/stocknumber.txt");
		BufferedReader br = new BufferedReader(fi);
		String Exp_Data = br.readLine();
		//if search textbox isdisplayed dont click searchpanel button
	...
	//method for supplier number to catupre
	public static void captuersupplier(String LocatorType,String LocatorValue)throws Throwable
	{
	...
	{
		//read stock number from notepad
				FileReader fi = new FileReader("./CaptureData/suppliernumber.txt");
				BufferedReader br = new BufferedReader(fi);
				String Exp_Data = br.readLine();
				//if search textbox isdisplayed dont click searchpanel button
				if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
				...
				Reporter.log(Act_data+"     "+Exp_Data,true);
				try {
					Assert.assertEquals(Act_data, Exp_Data,"Suppler Number Not Matching");
				} catch (Exception e) {
					Reporter.log(e.getMessage());
				}
	}
	...
	//method for supplier table
		...
		{
			//read stock number from notepad
					FileReader fi = new FileReader("./CaptureData/customernumber.txt");
					BufferedReader br = new BufferedReader(fi);
					String Exp_Data = br.readLine();
					//if search textbox isdisplayed dont click searchpanel button
					if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
